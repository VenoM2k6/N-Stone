...
begin
  ...
  oldtop := card2_2.top;
  if (player2.mana >= dcard3.manacost) then begin
...
procedure TshowIngame.card2_2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  if (card2_2.dragging) AND (player2.mana >= dcard3.manacost) then
  begin
...
procedure TshowIngame.card2_3MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
   if (card2_3.dragging) AND (player2.mana >= dcard3.manacost) then
  begin
...
begin
  ...
  oldtop := card2_4.top;
  if (player2.mana >= dcard4.manacost) then begin
...
procedure TshowIngame.card2_4MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  if (card2_4.dragging) AND (player2.mana >= dcard4.manacost)  then
  begin
